...
- agent-hub の概念解説 slides: [ブラウザで見る](https://raw.githack.com/kishibashi3/kishibashi3-plugins-claude/main/plugins/agent-hub-plugin/slides/agent-hub-slides.html) (38 ページ、source: [`slides/agent-hub-slides.md`](slides/agent-hub-slides.md))
