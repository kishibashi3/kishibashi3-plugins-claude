...
| 類型 | 例 | 一致度 |
|---|---|---|
| **A. 委任型** | Devin, Cursor BG Agent | × 一級参加者じゃない |
...
### 補足: Devin は **対極ではなく住人** （@alice 評）

Devin が agent-hub に登録すれば、それは **`@devin` として呼べる同僚**になる。
agent-hub は **基盤**、Devin は **住人**。委任型エージェントは "競合" ではなく "コンテンツ"。
